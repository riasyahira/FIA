...
#6.2.1.14
echo "-F path=" $1 "" >> /etc/audit/audit.rules
echo "-F perm=x" >> /etc/audit/audit.rules
echo "-F auid>=1000" >> /etc/audit/audit.rules
echo "-F auid!= 4294967295" >> /etc/audit/audit.rules
